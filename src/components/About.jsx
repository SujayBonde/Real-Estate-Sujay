    ...
    <motion.div initial={{opacity: 0, x:200}} transition={{duration: 1}} whileInView={{opacity: 1, x:0}} viewport={{once: true}} className='flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='about'>
      ...
      <div className='flex flex-col md:flex-row items-center md:items-start gap-20'>
        ...
        <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
          ...
          <p className='my-8 max-w-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias sed accusamus praesentium autem voluptate assumenda. Dolorum dolores incidunt iusto doloremque libero unde illum veniam, aperiam.</p>

          <button className='bg-blue-600 text-white px-8 py-2 rounded cursor-pointer'>Leran More</button>
        </div>
      </div>
    </motion.div>
  )
